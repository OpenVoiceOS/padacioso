...
- [ ] 4. Fix excluded-keywords substring bug (`_filter`)
- [ ] 5. Fix greedy entity capture for multi-entity patterns (`add_intent`, `_match`)
- [ ] 6. Skip cased pass for all-lowercase queries (`_match`)
